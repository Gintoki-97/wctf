    ...
    <div id="header">
        <div class="main">
            <div class="header-logo">
                <a class="logo" href="${root}/index" title="WCTF社区" style="background: url(${server}/static/image/logo5.png) no-repeat 10px;background-size: 20%;text-indent: 70px;color: #ccc;font-weight: 100;font-size: 17px;">WCTF 社区</a>
            </div>
