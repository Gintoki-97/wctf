          ...
          <ul class="nav" id="main-menu">
            <li class="active">
              ...
              <ul class="nav nav-second-level">
                <li>
                  <a href="javascript:;" class="active-menu">用户列表</a>
                </li>
                <li>
      ...
      <div id="page-wrapper">
        <div class="header">
          ...
          <ol class="breadcrumb">
            ...
            <li>
              <a href="${root}/admin/user">用户列表</a></li>
          </ol>
        </div>
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12 wrapper clear">
              <div class="layui-btn-group" style="float: left;">
                <button class="layui-btn layui-bg-black layui-btn-sm">
