		...
		<div class="layui-row layui-col-space15 warp">
			<div class="layui-col-md8 content">
				...
				<ul class="panel res-box">
					<c:if test="${requestScope.paging.list.size() gt 0}">
					...
					<c:if test="${requestScope.paging.list.size() eq 0}">
						<div style="height: 80px;line-height: 80px;padding: 10px 100px;color: #666;">
							<i class="layui-icon" style="font-size: 48px;">&#xe61c;</i>
							@_@ 找不到相关资源，请尝试更换其他条件进行搜索
						</div>
					</c:if>
